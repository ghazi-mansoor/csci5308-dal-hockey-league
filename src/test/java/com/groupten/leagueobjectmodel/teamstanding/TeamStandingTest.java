...
public class TeamStandingTest{
    ...
    public void getTeamNameTest() {
        TeamStanding teamStanding = new TeamStanding(new Team("Team 1"),"Division1","Conference1",1,2,3,4);
    ...
    public void setTeamNameTest() {
        TeamStanding teamStanding = new TeamStanding(new Team("Team 1"),"Division1","Conference1",1,2,3,4);
        teamStanding.setTeam(new Team("Team 11"));
    ...
    public void compareToTest() {
        TeamStanding teamStanding = new TeamStanding(new Team("Team 1"),"Division1","Conference1",1,2,3,4);
        TeamStanding teamStanding2 = new TeamStanding(new Team("Team 2"),"Division1","Conference1",5,6,7,8);
